...
author: gummibeer
description: 'A privacy issue in a service my family uses reminded me how quickly one wrong authorization assumption can expose years of data that should not exist anymore.'
---
...
It's about how one seemingly small authorization mistake can expose a much larger problem in how an application treats sensitive data.
...
Authorization, retention, data minimization, restrictive defaults and lifecycle cleanup are boring compared to shipping another feature.

They also make the difference between "this user saw one thing they shouldn't" and "this user suddenly has access to an archive that should never have been available in the first place."
