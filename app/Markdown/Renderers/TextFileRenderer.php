...
final class TextFileRenderer implements NodeRendererInterface
{
    public function render(Node $node, ChildNodeRendererInterface $childRenderer): \Stringable|string|null
    {
        ...
        return view('components.text-file', [
            'id' => 'text-file-'.substr(hash('sha256', $node->path()), 0, 12),
    ...
    private function resolvePath(string $path): string
    {
        ...
        if (
            ...
            throw new RuntimeException("Text file asset [{$path}] does not exist inside public/assets.");
        }
