        ...
        <ul class="list-inline flex flex-row space-x-2">
            <li>
                <a
                    ...
                    title="Twitter"
                    ><x-icon class="fab fa-twitter" /><span class="sr-only">Twitter</span></a
                >
            </li>
            <li>
                <a
                    ...
                    class="block p-1 hover:text-brand"
                    title="GitHub"
                    ><x-icon class="fab fa-github" /><span class="sr-only">GitHub</span></a
                >
            </li>
            <li>
                <a
                    href="{{ $identity?->strava_url }}"
                    target="_blank"
                    rel="noreferrer noopener"
                    class="block p-1 hover:text-brand"
                    title="Strava"
                    ><x-icon class="fab fa-strava" /><span class="sr-only">Strava</span></a
                >
            </li>
            <li>
                <a
                    ...
                    class="block p-1 hover:text-brand"
                    title="Steam"
                    ><x-icon class="fab fa-steam" /><span class="sr-only">Steam</span></a
                >
            </li>
        </ul>
    </div>
