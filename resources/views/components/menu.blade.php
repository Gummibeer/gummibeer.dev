...
>
  ...
  <a href="{{ route('home') }}" class="inline-block px-0 py-4 font-logo text-2xl leading-none tracking-wider whitespace-nowrap lg:text-3xl">
      Tom Herrmann
  </a>
        </div>
  ...
  aria-label="Toggle main menu"
        >
  <span class="absolute h-0.5 w-6 bg-current transition-transform duration-200" :class="show ? 'rotate-45' : '-translate-y-2'"></span>
  <span class="absolute h-0.5 w-6 bg-current transition-opacity duration-200" :class="show ? 'opacity-0' : 'opacity-100'"></span>
  <span class="absolute h-0.5 w-6 bg-current transition-transform duration-200" :class="show ? '-rotate-45' : 'translate-y-2'"></span>
  <span class="sr-only">Toggle main menu</span>
    ...
    <ul
        class="flex w-full flex-col list-none md:w-auto md:flex-row md:space-x-2 lg:space-x-4"
