...
@push('head')
    ...
    <x-link-feed route="blog.author.feed" :parameters="['author' => $author->slug()]"/>
@endpush

@section('content')
    <x-section>
        <h1 class="mb-8 text-6xl font-black leading-none text-night-0 dark:text-white">Posts by {{ $author->title }}</h1>
